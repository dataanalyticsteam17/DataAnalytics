...
// //       ArrayList<AnalysisRecord> ls = get_AnalysisRecord_list(start_time,end_time,symbol);
...
//    }
    ...
    public static Analysis getAnalysis(String start_date, String end_date,String symbol)
        ...
        ArrayList<AnalysisRecord> ls = AnalysisRecord.get_analysisrecord(start_date, end_date,symbol);
...
// Element low_diff, 最小价差
// float avg_diff,平均价差
// Element high_volume,最高交易量
// Element low_volume,最低交易量
// float avg_volume) 平均交易量
//
...
public static ArrayList<AnalysisRecord> get_AnalysisRecord_list(String start_date, String end_date,String symbol)
        throws IOException,java.text.ParseException{
    ArrayList<AnalysisRecord> analysisRecords = AnalysisRecord.get_analysisrecord(start_date, end_date,symbol);
