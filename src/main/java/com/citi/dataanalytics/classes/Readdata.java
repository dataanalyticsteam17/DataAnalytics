...
public  static String abspath="C:\\Users\\Administrator\\Desktop\\Quant Quote Market Data - Jan to Mar 2016\\";
...
//        }
    ...
    public static ArrayList<Record> acessData(String start_time, String end_timn, String start_date, String end_date,String symbol) throws IOException, java.text.ParseException{
        ArrayList<String> alldata , newlist= new  ArrayList<String>();
        ArrayList<Record> record_list = new ArrayList<Record>();
        ...
        for( int i=0;i<alldata.size();i++){
            ...
            if((d_fromrecord.equals(d_time_st) || d_fromrecord.after(d_time_st )) && ((d_fromrecord.before(d_time_en) || d_fromrecord.equals(d_time_en) ))){
                newlist.add(str);
            }
    ...
    public static ArrayList<Record> acessData(String start_time, String end_time,String symbol) throws IOException, java.text.ParseException {
    ...
    public static  ArrayList<String>  readData( String start_time, String end_time,String symbol)throws IOException, java.text.ParseException {
        ArrayList<String> allString = new ArrayList<String>();
        String filepath;
        //filepath="C:\\Users\\Jiawei\\Desktop\\DataAnalytics\\Data Analytics\\Test Data\\Quant Quote Market Data - Jan to Mar 2016\\allstocks_20160104\\table_a.csv";
